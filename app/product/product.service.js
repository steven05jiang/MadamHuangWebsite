...
var ProductService = (function () {
    ...
    ProductService.prototype.getObjects = function (page, size) {
        var _this = this;
        var apiRequest = ({
            apiKey: '',
            operator: '',
    ...
    ProductService.prototype.emitStatusChangeEvent = function (object, message) {
        this.statusChange.emit({ object: object, message: message });
    };
    ProductService.prototype.getStatusChangeEmitter = function () {
